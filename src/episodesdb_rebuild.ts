// Wipe and rebuild an Episodes Table. Mostly a development tool,
// for use when I've changed my data structures.
...
// multiple shows to include Soundcheck, New Sounds Live, Live from
// the Poisson Rouge. In fact much of the good material from those
// eventually finds its way into New Sounds, so this may be adequately
// covered.
